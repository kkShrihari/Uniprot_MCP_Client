"""
Command-line interface for Uniport_MCP_Client.
"""
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  Uniport_MCP_Client method1 --param1 "test"
  Uniport_MCP_Client method2 --param1 "test" --param2 42
  Uniport_MCP_Client method3
        """
    )
